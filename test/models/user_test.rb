...
class UserTest < ActiveSupport::TestCase
	...
	test "new user is added as participant to invited event" do
		...
		assert_equal expected_size, @event.users.length, "Event users' size must increase by one after adding new participant"
		assert_equal expected_users, @event.users, "Event users expected to grow by newly added participant"
